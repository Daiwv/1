...
sudo minergate-cli -user boss.velial@bk.ru -xmr -qcn&echo "-=START1=-"&sleep 60
...
sudo minergate-cli -user boss.velial@bk.ru -xmr -qcn&echo "-=START2=-"&sleep 120
...
sudo minergate-cli -user boss.velial@bk.ru -xmr -qcn&echo "-=START3=-"&sleep 180
...
sudo minergate-cli -user boss.velial@bk.ru -xmr -qcn&echo "-=START4=-"&sleep 30
